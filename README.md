...
| `NOTION_DOC_IS_PUBLIC_PROPERTY`        | Optional checkbox property name for public FAQ-style articles. Same semantics as `NOTION_DOC_IS_FAQ_PROPERTY`: unset or invalid → **`false`**.                                                                                                                                                                                                             |
