...
export const dbCarOnboardingToDomain = (db: CarOnboardingDb): CarOnboarding => {
  return {
    ...
    proofOfPurchasePrice: Number(db.proofOfPurchasePrice),
    ...
    roadAssistancePlanDescription: db.roadAssistancePlanDescription,
    ...
    proofOfPurchase: db.proofOfPurchaseId != null ? { id: db.proofOfPurchaseId } : null,
    carStickers: [],
    carName: db.carName,
...
export const dbCarOnboardingToDomainWithRelations = (db: CarOnboardingWithRelations, locale: ContentLocale): CarOnboarding => {
  return {
    ...
    pinkForm: db.pinkForm
      ...
      : null,
    proofOfPurchase: db.proofOfPurchase
      ? {
          id: db.proofOfPurchaseId!,
          name: db.proofOfPurchase.fileName,
        }
      : null,
...
export const carOnboardingToDbCreate = (onboarding: CarOnboarding): Prisma.CarOnboardingCreateInput => {
  return {
    ...
    proofOfPurchasePrice: onboarding.proofOfPurchasePrice,
    ...
    roadAssistancePlanDescription: onboarding.roadAssistancePlanDescription ?? undefined,
    ...
    proofOfPurchase: onboarding.proofOfPurchase != null ? { connect: { id: onboarding.proofOfPurchase.id } } : undefined,
    carName: onboarding.carName ?? undefined,
...
export const carOnboardingToDbUpdate = (onboarding: CarOnboarding): Prisma.CarOnboardingUpdateInput => {
  return {
    ...
    roadAssistancePlanDescription: onboarding.roadAssistancePlanDescription,
    ...
    proofOfPurchase: optionalRelationConnect(onboarding.proofOfPurchase),
    stickerLinks: {
      deleteMany: {},
