...
export const dbSimulationToDomain = (db: SimulationDb): Simulation => {
  return {
    ...
    resultMinSharedKm: db.resultMinSharedKm,
    resultAvgSharedKm: db.resultAvgSharedKm,
    resultMaxSharedKm: db.resultMaxSharedKm,
...
export const simulationToDbCreate = (simulation: Simulation): Prisma.SimulationCreateInput => {
  return {
    ...
    resultMinSharedKm: simulation.resultMinSharedKm ?? undefined,
    resultAvgSharedKm: simulation.resultAvgSharedKm ?? undefined,
    resultMaxSharedKm: simulation.resultMaxSharedKm ?? undefined,
