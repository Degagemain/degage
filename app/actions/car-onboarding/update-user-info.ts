import { carOnboardingUserInfoInputSchema } from '@/domain/car-onboarding.model';
...
export const updateCarOnboardingUserInfo = async (id: string, body: unknown, user: UserWithRole): Promise<void> => {
  ...
  const parsed = carOnboardingUserInfoInputSchema.parse(body);
