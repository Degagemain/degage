...
import type { ProofOfPurchaseUploadFile } from '@/actions/car-onboarding/upload-proof-of-purchase';
...
const parseUploadFile = async (request: NextRequest): Promise<ProofOfPurchaseUploadFile | Response> => {
...
export const tryCarOnboardingProofOfPurchaseUpload = async (
  request: NextRequest,
  id: string,
  upload: (id: string, file: ProofOfPurchaseUploadFile, user: UserWithRole) => Promise<void>,
  routeName: string,
  user: UserWithRole,
): Promise<Response> => {
