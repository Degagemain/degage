...
const SORT_COLUMN_MAP: Record<string, string> = {
  title: ChatConversationSortColumns.TITLE,
  createdAt: ChatConversationSortColumns.CREATED_AT,
  updatedAt: ChatConversationSortColumns.UPDATED_AT,
};
...
export default function ChatConversationsPage() {
  ...
  }, [debouncedQuery, userIds, pageIndex, pageSize, sorting]);
