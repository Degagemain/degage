...
export default function SimulationsPage() {
  ...
  const [columnVisibility, setColumnVisibility] = useState<VisibilityState>({
    ...
    carType: false,
    carTypeOther: false,
    ownerKmPerYear: false,
    purchasePrice: false,
    isPurchased: false,
    isVan: false,
    resultTaxCostPerYear: false,
    resultInspectionCostPerYear: false,
    resultMaintenanceCostPerYear: false,
    resultRoundedKmCost: false,
    resultMinSharedKm: false,
    resultAvgSharedKm: false,
    resultMaxSharedKm: false,
    resultEuroNorm: false,
    resultEcoScore: false,
    resultConsumption: false,
    resultCc: false,
    resultCo2: false,
  ...
  const columnLabels = useMemo(
    () => ({
      ...
      ownerKmPerYear: t('columns.ownerKmPerYear'),
      ...
      resultEstimatedCarValue: t('columns.resultEstimatedCarValue'),
      resultDepreciationCostKm: t('columns.resultDepreciationCostKm'),
      resultInsuranceCostPerYear: t('columns.resultInsuranceCostPerYear'),
      resultTaxCostPerYear: t('columns.resultTaxCostPerYear'),
      resultInspectionCostPerYear: t('columns.resultInspectionCostPerYear'),
      resultMaintenanceCostPerYear: t('columns.resultMaintenanceCostPerYear'),
      resultRoundedKmCost: t('columns.resultRoundedKmCost'),
      resultMinSharedKm: t('columns.resultMinSharedKm'),
      resultAvgSharedKm: t('columns.resultAvgSharedKm'),
      resultMaxSharedKm: t('columns.resultMaxSharedKm'),
      resultEuroNorm: t('columns.resultEuroNorm'),
      resultEcoScore: t('columns.resultEcoScore'),
      resultConsumption: t('columns.resultConsumption'),
      resultCc: t('columns.resultCc'),
      resultCo2: t('columns.resultCo2'),
      rejectionReason: t('columns.rejectionReason'),
