...
export default function HubsPage() {
  ...
  const [columnVisibility, setColumnVisibility] = useState<VisibilityState>({
    ...
    simMaxPrice: false,
    simAcceptedPriceCategoryA: false,
  ...
  const columnLabels = useMemo(
    () => ({
      ...
      minSharedKm: t('columns.minSharedKm'),
      avgSharedKm: t('columns.avgSharedKm'),
      maxSharedKm: t('columns.maxSharedKm'),
      ...
      simMaxPrice: t('columns.simMaxPrice'),
      simAcceptedPriceCategoryA: t('columns.simAcceptedPriceCategoryA'),
