...
export const carOnboarding = (data: Partial<CarOnboarding> = {}): CarOnboarding => {
  return {
    ...
    proofOfPurchasePrice: data.proofOfPurchasePrice ?? 0,
    ...
    roadAssistancePlanDescription: data.roadAssistancePlanDescription !== undefined ? data.roadAssistancePlanDescription : null,
    ...
    proofOfPurchase: data.proofOfPurchase !== undefined ? data.proofOfPurchase : null,
...
export const completeCarOnboarding = (data: Partial<CarOnboarding> = {}): CarOnboarding => {
  return carOnboarding({
    ...
    carName: 'TestCar',
    shareStartDate: new Date(new Date().getFullYear(), new Date().getMonth(), 1),
