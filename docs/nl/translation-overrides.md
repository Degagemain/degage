...
| ---------- | ----------------------------------------------------- |
| Pad        | Locatie van de tekst in de vertaalcatalogus.          |
| Origineel  | Huidige tekst uit de message-bestanden.               |
| Override   | Vervangende tekst die in de applicatie wordt getoond. |
