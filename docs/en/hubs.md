...
7. **Category outcome** — Based on quality score, rounded km cost (€/km), seats, and hub context, result becomes **Category A**, **Category B**,
   ...
   **default** hub only, **Category A** can still be assigned if depreciation cost per km is at or below **Cat. A deprec. €/km (default hub)**.
   For **electric** vehicles, **Category A** can apply if depreciation cost per km is at or below **Cat. A deprec. €/km (electric)**.
