...
**Delete**. **New** opens a form to create manual documentation (title and content in one or more languages, format, audience, tags, and
...
change FAQ visibility, public visibility, groups, and format—the headline and body stay synced from the repository. You cannot delete those from
the list; they follow the repository.
...
| Public      | When enabled, the item can appear as a public article on the Help & FAQ page (may be combined with audience and FAQ settings).                                                                                           |
