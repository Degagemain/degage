...
plusieurs langues, format, public, tags, groupes). Lors de l’édition, vous pouvez changer le format entre texte brut et Markdown. Pour les
contenus dépôt, l’édition permet de modifier la FAQ, la visibilité publique, les groupes et le format — le titre et le texte restent
...
| Article public | Si activé, l’entrée peut apparaître comme article public sur la page Aide & FAQ (combinable avec le public cible et la FAQ).                                                                                       |
