...
7. **Categorie finale** — Selon le score qualite, le cout au km arrondi (EUR/km), les places et le contexte du hub, le resultat devient
   **Category A**, **Category B** ou **Not OK**. Pour **Category A** avec moins de 7 places, le cout au km arrondi doit etre au plus **Cat. A
   ...
   sont rattaches a **Category B**. Sur le **hub par defaut** seulement, **Category A** peut encore s'appliquer si le cout de depreciation par
   km est au plus **Cat. A dépréc. EUR/km (hub par défaut)**. Pour les vehicules **electriques**, **Category A** peut s'appliquer si le cout de
   depreciation par km est au plus **Cat. A dépréc. EUR/km (électrique)**.
